...
#endif
#include "nesl_rtw.h"
#include "Assembly1_3ef711a9_1.h"
#include "Assembly1_3ef711a9_1_gateway.h"
void Assembly1_3ef711a9_1_gateway ( void ) { NeModelParameters modelparams =
{ ( NeSolverType ) 0 , 0.001 , 1 , 0.001 , 0 , 0 , 0 , 0 , (
SscLoggingSetting ) 0 , 502988822 , } ; NeSolverParameters solverparams = { 0
...
sizeof ( outputparameters_init [ 0 ] ) ; } Assembly1_3ef711a9_1_dae ( & dae ,
& modelparams , & solverparams ) ; nesl_register_simulator_group (
"Assembly1/Solver Configuration_1" , 1 , & dae , & solverparams , &
