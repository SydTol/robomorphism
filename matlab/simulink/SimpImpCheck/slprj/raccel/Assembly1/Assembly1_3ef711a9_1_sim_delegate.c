...
void Assembly1_3ef711a9_1_resetSimStateVector ( const void * mech , double *
state ) { double xx [ 1 ] ; ( void ) mech ; xx [ 0 ] = 0.0 ; state [ 0 ] = xx
[ 0 ] ; state [ 1 ] = xx [ 0 ] ; state [ 2 ] = xx [ 0 ] ; state [ 3 ] = xx [
0 ] ; state [ 4 ] = xx [ 0 ] ; state [ 5 ] = xx [ 0 ] ; } static void
...
} void Assembly1_3ef711a9_1_constructStateVector ( const void * mech , const
...
fullState [ 5 ] = solverState [ 5 ] ; } void
...
fullState [ 4 ] ; solverState [ 5 ] = fullState [ 5 ] ; } int
...
void ) modeVector ; return 0 ; } int Assembly1_3ef711a9_1_isVelocityViolation
...
PmfMessageId Assembly1_3ef711a9_1_projectStateSim ( const void * mech , const
...
) error ; } void Assembly1_3ef711a9_1_resetModeVector ( const void * mech ,
int * modeVector ) { ( void ) mech ; ( void ) modeVector ; }
