...
#include "ne_ds.h"
#include "Assembly1_e38647b6_1_ds_zc.h"
#include "Assembly1_e38647b6_1_ds_obs_all.h"
#include "Assembly1_e38647b6_1_ds_obs_act.h"
#include "Assembly1_e38647b6_1_ds_log.h"
#include "Assembly1_e38647b6_1_ds_dxf.h"
#include "Assembly1_e38647b6_1_ds_f.h"
#include "Assembly1_e38647b6_1_ds.h"
#include "ssc_ml_fun.h"
#include "Assembly1_e38647b6_1_ds_external_struct.h"
#include "Assembly1_e38647b6_1_ds_sys_struct.h"
#include "Assembly1_e38647b6_1_ds_externals.h"
...
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 0U , TRUE ,
1.0 , "1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 2U , 1U , TRUE ,
1.0 , "1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 3U , TRUE ,
1.0 , "1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 3U , 4U , FALSE ,
1.0 , "1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 7U , 7U , FALSE ,
1.0 , "1" , } } ; static NeICRData * s_icr_data = NULL ; static
NeVariableData s_variable_data [ 5 ] = { {
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive.private.w" , 0U , 0 ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1.0 , "1" , 0.0 ,
TRUE , FALSE , 1U , 1U , NE_INIT_MODE_MANDATORY , "Angular velocity" , } , {
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive.torque_ref" , 0U , 0 ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1.0 , "1" , 0.0 ,
TRUE , FALSE , 1U , 1U , NE_INIT_MODE_NONE , "Demanded torque" , } , {
"MotorSubSys_2.DC_Voltage.i" , 0U , 0 , "Assembly1/MotorSubSys 2/DC Voltage"
, 1.0 , "1" , 0.0 , FALSE , FALSE , 1U , 1U , NE_INIT_MODE_NONE , "Current" ,
} , { "MotorSubSys_2.Ideal_Torque_Sensor.T" , 0U , 0 ,
"Assembly1/MotorSubSys 2/Ideal Torque Sensor" , 1.0 , "1" , 0.0 , FALSE ,
FALSE , 1U , 1U , NE_INIT_MODE_NONE , "T" , } , {
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive.torque_elec" , 0U , 0 ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1.0 , "1" , 0.0 ,
FALSE , FALSE , 1U , 1U , NE_INIT_MODE_NONE , "Electrical torque" , } } ;
static NeVariableData * s_discrete_data = NULL ; static NeObservableData
s_observable_data [ 30 ] = { { "MotorSubSys_2.DC_Voltage.i" ,
"Assembly1/MotorSubSys 2/DC Voltage" , 1U , 1U , "A" , 1.0 , "A" ,
NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current" , } , {
"MotorSubSys_2.DC_Voltage.n.v" , "Assembly1/MotorSubSys 2/DC Voltage" , 1U ,
1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE ,
FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"MotorSubSys_2.DC_Voltage.p.v" , "Assembly1/MotorSubSys 2/DC Voltage" , 1U ,
1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE ,
FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"MotorSubSys_2.DC_Voltage.v" , "Assembly1/MotorSubSys 2/DC Voltage" , 1U , 1U
, "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE ,
FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"MotorSubSys_2.ERef.V.v" , "Assembly1/MotorSubSys 2/ERef" , 1U , 1U , "V" ,
1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"MotorSubSys_2.Ideal_Torque_Sensor.C.w" ,
"Assembly1/MotorSubSys 2/Ideal Torque Sensor" , 1U , 1U , "rad/s" , 1.0 ,
"1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"MotorSubSys_2.Ideal_Torque_Sensor.R.w" ,
"Assembly1/MotorSubSys 2/Ideal Torque Sensor" , 1U , 1U , "rad/s" , 1.0 ,
"1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"MotorSubSys_2.Ideal_Torque_Sensor.T" ,
"Assembly1/MotorSubSys 2/Ideal Torque Sensor" , 1U , 1U , "N*m" , 1.0 , "N*m"
, NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE ,
...
"MotorSubSys_2.Ideal_Torque_Sensor.w" ,
"Assembly1/MotorSubSys 2/Ideal Torque Sensor" , 1U , 1U , "rad/s" , 1.0 ,
"1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Angular velocity" , } , {
"MotorSubSys_2.MRRef_Motor.W.w" , "Assembly1/MotorSubSys 2/MRRef Motor" , 1U
...
, } , { "MotorSubSys_2.MRRef_Torque.W.w" ,
"Assembly1/MotorSubSys 2/MRRef Torque" , 1U , 1U , "rad/s" , 1.0 , "1/s" ,
NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"MotorSubSys_2.SM_Motor.C.w" , "Assembly1/MotorSubSys 2/SM Motor" , 1U , 1U ,
"rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } ,
{ "MotorSubSys_2.SM_Motor.R.w" , "Assembly1/MotorSubSys 2/SM Motor" , 1U , 1U
, "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" ,
} , { "MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive.Omega" ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 1U , "rad/s"
, 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE
, NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "w" , } , {
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive.R.w" ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 1U , "rad/s"
, 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE
, NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive.Tr" ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 1U , "N*m" ,
1.0 , "N*m" , NE_NOMINAL_SOURCE_FIXED , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Tr" , } , {
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive.Vm.v" ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 1U , "V" ,
1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive.Vp.v" ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 1U , "V" ,
1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive.C.w" ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 1U , "rad/s"
, 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE
, NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive.faulted" ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 1U , "1" ,
1.0 , "1" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Faulted flag" , } , {
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive.i" ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 1U , "A" ,
1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current" , } , {
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive.power_dissipated" ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 1U , "W" ,
1.0 , "kW" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Power dissipated" , } , {
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive.t" ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 1U , "N*m" ,
1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Torque" , } , {
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive.torque_elec" ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 1U , "N*m" ,
1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Electrical torque" , } , {
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive.torque_ref" ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 1U , "N*m" ,
1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , TRUE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Demanded torque" , } , {
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive.v" ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 1U , "V" ,
1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive.private.w" ,
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 1U , "rpm" ,
1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_MANDATORY , FALSE ,
TRUE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Angular velocity" , } , {
"MotorSubSys_2.SM_Motor.V0.v" , "Assembly1/MotorSubSys 2/SM Motor" , 1U , 1U
, "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE ,
FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"MotorSubSys_2.SM_Motor.V1.v" , "Assembly1/MotorSubSys 2/SM Motor" , 1U , 1U
, "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE ,
FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } } ; static
NeModeData * s_major_mode_data = NULL ; static NeZCData s_zc_data [ 4 ] = { {
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 0U ,
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive" ,
 "/usr/local/MATLAB/R2019b/toolbox/physmod/elec/library/m/+ee/+electromech/+pmsm/controlled_servomotor_base.sscp"
, NE_ZC_TYPE_FALSE , } , {
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 1U ,
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive" ,
 "/usr/local/MATLAB/R2019b/toolbox/physmod/elec/library/m/+ee/+electromech/+pmsm/controlled_servomotor_base.sscp"
, NE_ZC_TYPE_FALSE , } , {
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 2U ,
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive" ,
 "/usr/local/MATLAB/R2019b/toolbox/physmod/elec/library/m/+ee/+electromech/+pmsm/controlled_servomotor_base.sscp"
, NE_ZC_TYPE_FALSE , } , {
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 3U ,
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive" ,
 "/usr/local/MATLAB/R2019b/toolbox/physmod/elec/library/m/+ee/+electromech/+pmsm/controlled_servomotor_base.sscp"
...
, TRUE ,
 "In power, the base should be nonnegative when the exponent is not an integer. This may become error in future releases."
, "physmod:common:mf:core:asserts:RequireBaseNonnegative" , } , {
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 4U ,
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive" ,
 "/usr/local/MATLAB/R2019b/toolbox/physmod/elec/library/m/+ee/+electromech/+pmsm/controlled_servomotor_base.sscp"
, TRUE ,
 "In power, the exponent should be positive when the base is equal to zero. This may become error in future releases."
, "physmod:common:mf:core:asserts:RequireExponentPositive" , } , {
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 5U ,
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive" ,
 "/usr/local/MATLAB/R2019b/toolbox/physmod/elec/library/m/+ee/+electromech/+pmsm/controlled_servomotor_base.sscp"
, TRUE ,
 "In power, the base should be nonnegative when the exponent is not an integer. This may become error in future releases."
, "physmod:common:mf:core:asserts:RequireBaseNonnegative" , } , {
"Assembly1/MotorSubSys 2/SM Motor/Simplified PMSM Drive" , 1U , 6U ,
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive" ,
 "/usr/local/MATLAB/R2019b/toolbox/physmod/elec/library/m/+ee/+electromech/+pmsm/controlled_servomotor_base.sscp"
...
-> mN ) ; } NeDynamicSystem * Assembly1_e38647b6_1_dae_ds ( PmAllocator *
...
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive.Tr" ; input_info [ 0 ] . mM = 1
; input_info [ 0 ] . mN = 1 ; input_info [ 0 ] . mName =
"MotorSubSys_2.SM_Motor.Simplified_PMSM_Drive.Tr" ; input_info [ 0 ] . mUnit
= "N*m" ; ds -> mIo [ NE_INPUT_IO_TYPE ] = input_info ; ds -> mNumIo [
NE_OUTPUT_IO_TYPE ] = 1 ; output_info [ 0 ] . mIdentifier =
"MotorSubSys_2.Ideal_Torque_Sensor.T" ; output_info [ 0 ] . mM = 1 ;
output_info [ 0 ] . mN = 1 ; output_info [ 0 ] . mName =
"MotorSubSys_2.Ideal_Torque_Sensor.T" ; output_info [ 0 ] . mUnit = "N*m" ;
...
ds_output_c ; ds -> mMethods [ NE_DS_METHOD_F ] = Assembly1_e38647b6_1_ds_f ;
...
NE_DS_METHOD_DXF ] = Assembly1_e38647b6_1_ds_dxf ; ds -> mMakeOutput [
...
Assembly1_e38647b6_1_ds_zc ; ds -> mMakeOutput [ NE_DS_METHOD_ZC ] =
...
NE_DS_METHOD_LOG ] = Assembly1_e38647b6_1_ds_log ; ds -> mMakeOutput [
...
mMethods [ NE_DS_METHOD_OBS_ACT ] = Assembly1_e38647b6_1_ds_obs_act ; ds ->
mMakeOutput [ NE_DS_METHOD_OBS_ACT ] = ds_output_obs_act ; ds -> mMethods [
NE_DS_METHOD_OBS_ALL ] = Assembly1_e38647b6_1_ds_obs_all ; ds -> mMakeOutput
