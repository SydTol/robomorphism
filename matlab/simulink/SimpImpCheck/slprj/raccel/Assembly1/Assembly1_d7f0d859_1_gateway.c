...
#endif
#include "nesl_rtw.h"
#include "Assembly1_d7f0d859_1.h"
#include "Assembly1_d7f0d859_1_gateway.h"
void Assembly1_d7f0d859_1_gateway ( void ) { NeModelParameters modelparams =
...
sizeof ( outputparameters_init [ 0 ] ) ; } Assembly1_d7f0d859_1_dae ( & dae ,
& modelparams , & solverparams ) ; nesl_register_simulator_group (
"Assembly1/MotorSubSys /Solver Configuration1_1" , 1 , & dae , & solverparams
