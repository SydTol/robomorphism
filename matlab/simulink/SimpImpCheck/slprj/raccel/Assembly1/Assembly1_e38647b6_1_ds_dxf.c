...
int32_T Assembly1_e38647b6_1_ds_dxf ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t15 , NeDsMethodOutput * t16 ) { PmRealVector out ;
real_T t0 ; real_T t1 ; real_T X_idx_0 ; real_T X_idx_4 ; int32_T M_idx_1 ;
int32_T M_idx_0 ; int32_T M_idx_2 ; M_idx_0 = t15 -> mM . mX [ 0 ] ; M_idx_1
= t15 -> mM . mX [ 1 ] ; M_idx_2 = t15 -> mM . mX [ 2 ] ; X_idx_0 = t15 -> mX
. mX [ 0 ] ; X_idx_4 = t15 -> mX . mX [ 4 ] ; out = t16 -> mDXF ; t0 = fabs (
...
0.020833333333333332 * ( X_idx_4 * 0.001 + X_idx_0 * 8.705878170917697E-8 ) *
1000.0 ) ; out . mX [ 1 ] = t1 ; out . mX [ 2 ] = t0 ; out . mX [ 3 ] = - (
0.020833333333333332 * ( X_idx_0 * 0.001 + X_idx_4 * 0.1218243981768236 ) *
