...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(3).translation = [134.44999999999999 -0 0];  % mm
smiData.RigidTransform(3).angle = 0;  % rad
smiData.RigidTransform(3).axis = [0 0 0];
smiData.RigidTransform(3).ID = 'B[Mr5B9k7Tx7IX+InYW:-:MLeZHIkh5pzrdEW3N]';

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(4).translation = [-43.100000000000001 -0 15];  % mm
smiData.RigidTransform(4).angle = 0;  % rad
smiData.RigidTransform(4).axis = [0 0 0];
smiData.RigidTransform(4).ID = 'F[Mr5B9k7Tx7IX+InYW:-:MLeZHIkh5pzrdEW3N]';

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(5).translation = [0 0 25];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(6).translation = [-140.84999999999999 -0 15];  % mm
...
smiData.RigidTransform(7).ID = 'B[MTRs4YWKraIb20M7n:-:Mr5B9k7Tx7IX+InYW]';
...
smiData.RigidTransform(8).ID = 'F[MTRs4YWKraIb20M7n:-:Mr5B9k7Tx7IX+InYW]';
...
smiData.RevoluteJoint(1).ID = '[Mr5B9k7Tx7IX+InYW:-:MLeZHIkh5pzrdEW3N]';

smiData.RevoluteJoint(2).Rz.Pos = 1.8162762105646944e-05;  % deg
smiData.RevoluteJoint(2).ID = '[MMKXA8EfbNtMkHH6B:-:MTRs4YWKraIb20M7n]';

smiData.RevoluteJoint(3).Rz.Pos = 0;  % deg
smiData.RevoluteJoint(3).ID = '[MTRs4YWKraIb20M7n:-:Mr5B9k7Tx7IX+InYW]';
